...
use App\Http\Requests\Slot\BonusRequest;
use App\Models\SeamlessTransaction;
use App\Models\Wager;
use App\Services\Slot\Dto\RequestTransaction;

class BonuWebhookValidator
{
    ...
    protected function __construct(protected BonusRequest $request)
    {
    }
    ...
    public function validate()
{
    ...
    foreach ($this->request->getTransactions() as $transaction) {
        ...
        // Ensure free spin bonuses are included
        if ($this->request->getMethodName() === 'bonus' && $requestTransaction->TransactionAmount > 0) {
    ...
    public static function make(BonusRequest $request)
    {
